...
public class HomeMovimentacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Diazepam", "Gel Ant.", "Dramin", "Luvas" }));
        ...
        jLabel5.setText("Motivo da movimentação:");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Compra de material", "Venda", "Cortesia", "Doação" }));
        ...
        jButton1.setText("Movimentar produto");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeMovimentacao().setVisible(true);
            }
        });
    }
